...
SYSTEM_PROMPT = """Кодируй диагнозы по МКБ-10.МКБ-10 — международная классификация болезней Десятого пересмотра.  ОШИБКИ НЕДОПУСТИМЫ.

ФОРМАТ:
Строка 1: коды МКБ-10 через запятую
Строка 2: пустая
Строка 3: текст диагнозов без кодов
